...
//                     <BashCard />
//                 </div>
//                 <div className='flex items-center justify-center mt-6 min-[750px]:mt-0 min-[750px]:col-start-1 min-[750px]:col-end-6 min-[750px]:row-start-3 min-[750px]:row-end-4 border-2 border-white'>
//                     <Card ><div className='border border-black'></div></Card>
//                 </div>
