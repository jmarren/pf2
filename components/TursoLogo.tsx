...
export default function TursoLogo() {

  return (

    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 54" fill="none" className="h-10"><mask id="a" width="29" height="48" x="27" y="0" maskUnits="userSpaceOnUse" >
      ...
      <mask id="c" width="29" height="48" x="0" y="0" maskUnits="userSpaceOnUse" >
      ...
      <path fill="#4FF7D1" d="M77.845 19.474v23.372h-7.189V19.474l-7.988-.997V12.67h23.125v5.806l-7.948.997ZM88.073 30.81V12.67h7.19v18.14c0 3.402 1.59 5.756 5.123 5.756 3.532 0 5.039-2.399 5.039-5.8V12.67h7.189v18.095c0 7.282-4.136 12.644-12.318 12.644-8.182 0-12.228-5.058-12.228-12.6h.005ZM131.997 29.07l6.805 13.776h-7.708l-5.857-12.384h-1.936v12.384h-7.15v-30.17h10.248c6.246 0 9.389 3.272 9.389 8.983 0 3.356-1.376 5.93-3.791 7.411Zm-8.701-10.115v5.582h2.499c1.637 0 2.585-1.133 2.585-2.833 0-1.701-.993-2.749-2.585-2.749h-2.499ZM148.536 23.529l3.747 1.481c3.876 1.611 6.156 4.23 6.156 8.719 0 6.105-4.266 9.68-10.248 9.68-8.526 0-10.078-5.625-9.818-10.03h6.805c-.085 1.92.644 3.796 3.013 3.796 1.637 0 2.844-.918 2.844-2.658 0-1.74-1.207-2.529-3.143-3.272-1.507-.609-3.013-1.177-4.65-2.005-3.013-1.571-4.61-4.534-4.61-8.195 0-5.277 3.787-8.938 9.604-8.938 7.02 0 9.559 4.055 9.26 9.417h-6.63c.045-1.875-.903-3.182-2.585-3.182-1.681 0-2.454 1.002-2.454 2.27 0 1.266.688 2.134 2.714 2.922l-.005-.005ZM175.447 12.107c9.734 0 15.806 6.759 15.806 15.567s-6.032 15.74-15.591 15.74c-9.56 0-15.676-6.758-15.676-15.61 0-8.854 6.286-15.697 15.456-15.697h.005Zm.175 24.505c5.253 0 8.097-3.926 8.097-8.854 0-4.927-3.013-8.852-8.137-8.852-5.124 0-8.053 3.925-8.053 8.853 0 4.927 3.144 8.852 8.098 8.852h-.005Z">
      </path>
      <defs>
        <linearGradient id="b" x1="42.662" x2="27.939" y1="-45.879" y2="-45.879" gradientUnits="userSpaceOnUse">
          <stop stopColor="#1D2B33">
          </stop>
          <stop offset="1" stopColor="#121B24">
          </stop>
        </linearGradient>
