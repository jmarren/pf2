...
function SocialButtons() {
  return (
    ...
    <div className="social-buttons fixed  bottom-0 left-[40vw] z-20 hover:scale-105 transition ease-in-out duration-350">
      <Link href="https://github.com/jmarren" target='blank' className="social-button github">
      ...
      <Link href="https://www.linkedin.com/in/john-l-marren/" target='blank' className="social-button linkedin">
      ...
      <Link href='/Resume_John-Marren.pdf' target='blank'>
